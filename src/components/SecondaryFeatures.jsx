...
const features = [
  {
    ...
    description: 'Share your ride and save on travel costs.',
      ...
      <Container>
        <div className="mx-auto max-w-2xl sm:text-center">
          <h2 className="text-2xl font-medium tracking-tight text-gray-900">
            The Best Way to Share Rides. And Here&apos;s Why
          </h2>
          <p className="mt-2 text-lg text-gray-600">
            We want your journey to be seamless, so we created the most
            convenient, affordable, and eco-friendly ride-sharing app.
          </p>
        </div>
        <ul
          role="list"
